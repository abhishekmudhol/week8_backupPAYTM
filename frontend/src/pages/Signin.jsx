...
function SignIn() {
    ...
    try {
        ...
        if (response.data.token) {
            //localStorage.setItem('firstName' , data.f)
...
return (
    <div className="flex justify-center items-center h-screen bg-orange-100">
        <form onSubmit={handleSubmit(submit)} className="bg-white p-6 rounded-lg shadow-lg w-[25rem]">
            <h2 className="text-2xl font-bold mb-4 text-center text-orange-600">Sign In</h2>
            <p className="text-gray-800 mb-6 text-center">Enter your information to Sign In</p>
